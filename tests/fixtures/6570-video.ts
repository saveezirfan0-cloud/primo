...
type Row = Omit<ExtractedLineItem, "section_ref" | "is_rollup" | "parent_ref" | "grp"> &
  Partial<Pick<ExtractedLineItem, "is_rollup" | "parent_ref" | "grp">>;

/** Rows default to EQUIPMENT; tagging derives the real group from roll-up codes and nesting. */
function rows(section: string, list: Row[]): ExtractedLineItem[] {
  return list.map((r) => ({ section_ref: section, is_rollup: false, parent_ref: null, grp: "EQUIPMENT", ...r }));
}
...
export const videoExpandedWithParents: ExtractedLineItem[] = rows("S1", [
  ...
  { ref: "L5", description: "Cabling", part_number: "CABLING", qty: 1, unit_price: null, total: 816.7, is_rollup: true },
  { ref: "L6", parent_ref: "L5", description: "Cat 6A F/UTP Dual Data Outlet – 20mtrs", part_number: "CAT6A-DDO-20", qty: 2, unit_price: 190, total: 380 },
  { ref: "L7", parent_ref: "L5", description: "HDMI 2.0 active optical cable per metre", part_number: "HDMI-AOC", qty: 20, unit_price: 9.51, total: 190.2 },
  { ref: "L8", parent_ref: "L5", description: "Connectors and labels", part_number: null, qty: 1, unit_price: 96.5, total: 96.5 },
  { ref: "L9", parent_ref: "L5", description: "Contingency", part_number: null, qty: 1, unit_price: 150, total: 150 },
  ...
  { ref: "L12", description: "Services", part_number: "SERVICES", qty: 1, unit_price: null, total: 3056.79, is_rollup: true },
  { ref: "L13", parent_ref: "L12", description: "DE-COMM", part_number: null, qty: 1, unit_price: null, total: 92.73, is_rollup: true },
  { ref: "L14", parent_ref: "L13", description: "Decommission existing projector", part_number: null, qty: 1, unit_price: 30.91, total: 30.91 },
  { ref: "L15", parent_ref: "L13", description: "Decommission existing cabling", part_number: null, qty: 2, unit_price: 30.91, total: 61.82 },
  { ref: "L16", parent_ref: "L12", description: "INSTALL", part_number: null, qty: 1, unit_price: null, total: 294.81, is_rollup: true },
  { ref: "L17", parent_ref: "L16", description: "Install projector bracket", part_number: null, qty: 1, unit_price: 47.55, total: 47.55 },
  { ref: "L18", parent_ref: "L16", description: "Install projector", part_number: null, qty: 1, unit_price: 57.06, total: 57.06 },
  { ref: "L19", parent_ref: "L16", description: "Install ceiling speakers", part_number: null, qty: 1, unit_price: 190.2, total: 190.2 },
  { ref: "L20", parent_ref: "L12", description: "CABLING-INSTALL", part_number: null, qty: 1, unit_price: null, total: 237.75, is_rollup: true },
  { ref: "L21", parent_ref: "L20", description: "Run HDMI AOC per metre", part_number: null, qty: 20, unit_price: 9.51, total: 190.2 },
  { ref: "L22", parent_ref: "L20", description: "Terminate data outlets", part_number: null, qty: 1, unit_price: 47.55, total: 47.55 },
  { ref: "L23", parent_ref: "L12", description: "ENGINEER", part_number: null, qty: 1, unit_price: 552, total: 552, is_rollup: true },
  { ref: "L24", parent_ref: "L12", description: "COMMISSION", part_number: null, qty: 1, unit_price: 103.5, total: 103.5, is_rollup: true },
  { ref: "L25", parent_ref: "L12", description: "PROGRAM", part_number: null, qty: 1, unit_price: 1152, total: 1152, is_rollup: true },
  { ref: "L26", parent_ref: "L12", description: "PROJECT-MANAGE", part_number: null, qty: 1, unit_price: 624, total: 624, is_rollup: true },
]);

/** Same rows with the nesting information removed (what a flat table gives us). */
export const videoExpandedFlat: ExtractedLineItem[] = videoExpandedWithParents.map((r) => ({ ...r, parent_ref: null }));
...
export function jobWith(lines: ExtractedLineItem[], sectionTotal: number | null = VIDEO_TOTAL): ExtractedJob {
  return {
    header: {
      job_number: "6570",
    ...
    summary: {
      ...
      gst: sectionTotal === null ? null : Math.round(sectionTotal * 10) / 100,
      total_inc_gst: sectionTotal === null ? null : Math.round(sectionTotal * 110) / 100,
    },
    ...
    params: {
      room_type: "hall", install_type: "upgrade", staged: false, projectors_new: 1, projector_lumens: 7000,
      screens_new: 0, screens_retained: 1, speakers_new: 0, speakers_retained: null, audio_zones: null,
      amp_channels_new: null, wireless_mic_channels: null, wired_mics: null, dsp_new: null, dante: null,
      stage_io: null, touch_panels: null, control_processor: null, video_inputs: null, video_input_locations: null,
      wireless_presentation: null, rack: "reuse", rack_ru: null, hearing_augmentation: null, lighting_integration: null,
      recording_streaming: null, ewp_required: true, decomm_item_count: 2, optional_items_count: 0,
    },
  };
}
